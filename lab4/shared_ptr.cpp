...
int main()
{
	...
	int* p = new int(3);
	{
		...
		std::cout << "Shared ptr initialized by pointer: "
				<< a.get() << std::endl
				<< "Value: " << *a << std::endl
		...
		std::cout << std::endl;
		std::cout << "Shared ptr initialized by another shared: "
				<< b.get() << std::endl
				<< "Value: " << *b << std::endl
		...
		std::cout << std::endl;
		c = a;
		std::cout << "After assigning first shrd ptr to empty: "
				<< c.get() << std::endl
				<< "Value: " << *c << std::endl
				<< "Count: " << c.use_count() << std::endl
				<< "Bool: " << bool(c) << std::endl;
		...
		std::cout << std::endl;
		c.reset();
		std::cout << "After resetting shared to nullptr: "
				<< c.get() << std::endl
				// << "Value: " << *c << std::endl
				<< "Count: " << c.use_count() << std::endl
				<< "Bool: " << bool(c) << std::endl;
	...
	std::cout << "Shared ptrs destroyed, pointer: " << p << " "
			<< *p << std::endl;
	}

	std::cout << std::endl << "Step2--------------------" << std::endl;
	stepik::shared_ptr<Derived> derivedPtr(new Derived);
	stepik::shared_ptr<Base> basePtr = derivedPtr, basePtr2(new Base);
	std::cout << "Printing from basePtr that pointing at base: " << std::endl;
	basePtr2->print();
	std::cout << "Printing from basePtr that pointing at derived: " << std::endl;
	basePtr->print();
	std::cout << basePtr.get() << " " << derivedPtr.get() << ":" << std::endl;
	std::cout << "'==': " << (basePtr==derivedPtr) << std::endl;
	std::cout << "'!=': " << (basePtr!=derivedPtr) << std::endl;
	std::cout << "'<': " << (basePtr<derivedPtr) << std::endl;
	std::cout << "'>': " << (basePtr>derivedPtr) << std::endl;
	std::cout << "'<=': " << (basePtr<=derivedPtr) << std::endl;
	...
	std::cout << basePtr.get() << " " << basePtr2.get() << ":" << std::endl;
	std::cout << "'==': " << (basePtr==basePtr2) << std::endl;
	std::cout << "'!=': " << (basePtr!=basePtr2) << std::endl;
	std::cout << "'<': " << (basePtr<basePtr2) << std::endl;
	std::cout << "'>': " << (basePtr>basePtr2) << std::endl;
	std::cout << "'<=': " << (basePtr<=basePtr2) << std::endl;
	...
	std::cout << "nullptr " << basePtr.get() << std::endl;
	std::cout << "'==': " << (nullptr==basePtr) << std::endl;
	std::cout << "'!=': " << (nullptr!=basePtr) << std::endl;
	std::cout << "'<': " << (nullptr<basePtr) << std::endl;
	std::cout << "'>': " << (nullptr>basePtr) << std::endl;
	std::cout << "'<=': " << (nullptr<=basePtr) << std::endl;
	...
	std::cout << basePtr.get() << " nullptr" << std::endl;
	std::cout << "'==': " << (basePtr==nullptr) << std::endl;
	std::cout << "'!=': " << (basePtr!=nullptr) << std::endl;
	std::cout << "'<': " << (basePtr<nullptr) << std::endl;
	std::cout << "'>': " << (basePtr>nullptr) << std::endl;
	std::cout << "'<=': " << (basePtr<=nullptr) << std::endl;
